...
7. 基本文档全部完成。
8. 功能增加：内容可以被点赞和举报，当举报超过服务设置的值时会被违禁，管理员可以解除违禁，解除违禁时系统自动删除所有举报。举报和点赞只能是登录用户，每个人对每一个内容只有一次点赞和举报机会，可以取消点赞和举报。
9. 功能增加：对内容进行评论，对评论进行评论，对评论进行点赞和举报，举报超过某值评论被违禁，管理员可以设置违禁和解除违禁。
10. 功能调整：被违禁的内容在前端也可以列表列出，但进去单页时会报违禁提示。
11. 功能增加：互动消息站内信，如评论被点赞，内容被点赞，内容被评论，评论被评论。系统通知站内信，内容被违禁，评论被违禁，管理员通知。
